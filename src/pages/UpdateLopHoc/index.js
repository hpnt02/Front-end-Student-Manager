    ...
    <div>
       ...
       <h2 className={cx('title')}>Chỉnh sửa thông tin lớp học</h2>
           ...
           <div className={cx('infor-new')}>
               ...
               <Input label='Mã lớp học' type="text" placeholder="Chỉnh sửa mã lớp học" value={inputValue} onChange={handleInputChange}/>                                 
                   <Input label='Tên lớp học' type="text" placeholder="Chỉnh sửa tên lớp học" value={inputTenLH}  onChange={handleInputChange1}/>                                                            
   <SelectLabels 
                    title="Ngành"    
                    select={Allnganh}     
