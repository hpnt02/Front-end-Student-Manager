             ...
             <div className={cx('header-kv')}>
                <div className={cx('innerrr')}>
                      <div className={cx('qlkv')}>
                        <Link to={config.routes.ctdths}>
                              Chương trình đào tạo
                        </Link>
                      </div>
                      <div className={cx('qln')}>
                        <Link to={config.routes.khhtchs}>
                              Kế hoạch học tập học sinh
                        </Link>
                      </div>               
                </div>
            </div>
...
<div className={cx('wrapper')}>
        ...
        <Button type="test" primary onClick={handleClickCancel}>Thêm mới học phần</Button>:
        <Button type="test" primary to={config.routes.home}>Quay lại</Button>
