  ...
  return (  
         ...
         <div className={cx('innerr')}>
                <div className={cx('bgr-content')}>
                  ...
                  <div>
                  <Button type="text" primary to={config.routesAdmin.tm}> Thêm mới khoa </Button>
                    <Button type="text" disabled={selectedIDs.length === 0} primary onClick={handleClickCancel}> Xóa khoa</Button>      
            ...
            {onCancel ?                
                  <DeleteKhoa onCancel={handleUpdateDiemCancel} KhoaId={ selectedIDs}/>:""
                }
