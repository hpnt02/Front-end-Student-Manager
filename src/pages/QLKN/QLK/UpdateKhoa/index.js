     ...
     <h2 className={cx('title')}>Chỉnh sửa thông tin khoa</h2>
         ...
         <div className={cx('infor-newstudent')}>
             ...
             <div className={cx('witdh-input')}>
                  <Input label='Mã khoa' type="text" placeholder="Chỉnh sửa mã khoa" value={inputValue} onChange={handleInputChange}/>                                 
                
                 </div>
                 <br/>
                 <div className={cx('witdh-input')}>
                 <Input label='Tên khoa' type="text" placeholder="Chỉnh sửa tên khoa" value={inputTenKhoa} onChange={handleInputChange1}/>                                 
