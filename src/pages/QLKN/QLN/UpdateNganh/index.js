       ...
       <h2 className={cx('title')}>Thêm mới học sinh</h2>
           ...
           <div className={cx('infor-newstudent')}>
               <div>
                ...
                <Input label='Mã ngành' type="text" placeholder="Chỉnh sửa mã ngành" value={inputValue} onChange={handleInputChange}/>                                 
                  
                </div>
                   <br/>
                   <div className={cx('witdh-input')}>
                   <Input label='Tên ngành' type="text" placeholder="Chỉnh sửa tên ngành" value={inputTenNganh} onChange={handleInputChange1}/>                                 
           ...
           <div className={cx('button-center')}>
            <Button type="submit" primary>Lưu </Button>
            <Button type="text" primary to={config.routesAdmin.qln}>Quay lại </Button>
