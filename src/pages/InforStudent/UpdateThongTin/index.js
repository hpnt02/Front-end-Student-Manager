                    ...
                    <div className={cx('infor-student')}>
                        <div>
                            <Input
                                label="Họ tên mẹ"
                                type="text"
                                placeholder="Chỉnh sửa họ tên mẹh"
                                value={inputHTMe}
                                onChange={handleInputHoTenMe}
                            />
                            <br />
                            <Input
                                label="Nghề nghiệp mẹ"
                                type="text"
                                placeholder="Chỉnh sửa nghề nghiệp mẹ"
                                value={inputNNMe}
                                onChange={handleInputNNMe}
                            />
                            <br />
                            <Input
                                label="Só điện thoại mẹ"
                                type="text"
                                placeholder="Chỉnh sửa só điện thoại mẹ"
                                value={inputSDTMe}
                                onChange={handleInputSDTMe}
                            />
                        </div>
                        <div>
                            <Input
                                label="Họ tên cha"
                                type="text"
                                placeholder="Chỉnh sửa họ tên cha"
                                value={inputHTCha}
                                onChange={handleInputHoTenCha}
                            />
                            <br />
                            <Input
                                label="Nghề nghiệp cha"
                                type="text"
                                placeholder="Chỉnh sửa nghề nghiệp cha"
                                value={inputNNCha}
                                onChange={handleInputNNCha}
                            />
                            <br />
                            <Input
                                label="Só điện thoại cha"
                                type="text"
                                placeholder="Chỉnh sửa só điện thoại cha"
                                value={inputSDTCha}
                                onChange={handleInputSDTCha}
                            />
                        </div>
                    </div>
                </div>
