    ...
    return ( 
        ...
        <h2 className={cx('title')}>Thêm mới lớp học</h2>
                ...
                <div>
                    ...
                    <Input label='Mã lớp' placeholder='Vui lòng nhập mã lớp' onChange={(e) =>setMaLop(e.target.value)}/>
                    
                
              <br/>                   
                   <Input label='Tên lớp' placeholder='Vui lòng nhập tên lớp' onChange={(e) =>setTenLop(e.target.value)}/>
                   <br/>
                   <SelectLabels 
                  title="Ngành"    
                  select={Allnganh}     
...
<div className={cx('button-class')}>
    ...
    <Button primary type='text' to={config.routesAdmin.qlkv}>Quay lại</Button> 
</div>
            </div>
