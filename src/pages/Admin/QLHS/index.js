...
function QLHS() {
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                ...
                >
                    <FactCheckIcon style={{ color: 'blue' }} />
    ...
    function handleFilter(event) {
        ...
        const newData = resultArray.filter((row) => {
            ...
            return tenHocSinh.includes(searchValue) || maHS.includes(searchValue);
        });
        ...
        <div className={cx('wrapperr')}>
            <div className={cx('innerr')}>
                <div className={cx('bgr-content')}>
                        ...
                        <div className={cx('button-create')}>
                            {window.location.pathname === '/quan-ly-hoc-sinh' ? (
                                <>
                                    ...
                                    />
                                    <Button type="text" primary to={config.routesAdmin.tmhs}>
                                        Thêm mới học sinh
                                    </Button>
                                    <Button
                                        type="text"
                    ...
                    <div>
                        {onCancel ? <DeleteHS onCancel={handleUpdateDiemCancel} studentId={selectedIDs} /> : ''}
