    ...
    return (
        ...
        <h2 className={cx('title')}>Chỉnh sửa thông tin</h2>
            ...
            <div className={cx('infor-new')}>
              <div>              
                    <Input label='Mã học sinh' type="text" placeholder="Chỉnh sửa mã học sinh" value={inputValue} onChange={handleInputChange}/>   
                    <br/>
                    <Input label='Họ học sinh' type="text" placeholder="Chỉnh sửa họ học sinh" value={inputHoHS} onChange={handleInputChange4}/>            
                    <br/>
                    <Input label='Tên học sinh' type="text" placeholder="Chỉnh sửa tên học sinh" value={inputTenHS} onChange={handleInputChange5}/>                  
                    <br/>
