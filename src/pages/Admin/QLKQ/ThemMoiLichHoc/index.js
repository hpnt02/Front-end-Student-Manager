                    ...
                    <form className={cx('form-create')} onSubmit={handleCreate}>
                        <div className={cx('infor-new')}>
                            <div className={cx('infor-LichHoc')}>
                                ...
                                <Input
                                    label="Nhóm học phần"
                                    placeholder="Vui lòng nhập nhóm học phần"
                                    onChange={(e) => setNhomHP(e.target.value)}
                                />
                            </div>
                            <div className={cx('infor-LichHoc')}>
                                <SelectLabels
                            ...
                            <div className={cx('infor-LichHoc')}>
                                <SelectLabels
                                    title="Môn học"
                                    select={monhoctuongung}
                                    width={true}
                                    onChange={handleChangeMonHoc}
                                    other="MonHoc"
                                />
                                <Input
                                    label="Tiết"
                                    placeholder="Vui lòng nhập tiết học"
                            ...
                            <div className={cx('infor-LichHoc')}>
                                ...
                                <Input
                                    label="Phòng học"
                                    placeholder="Vui lòng nhập phòng học"
                        ...
                        <div className={cx('format-button')}>
                            ...
                            <Button type="text" primary to={config.routesAdmin.qlkhht}>
                                Quay lại
                            </Button>
                        </div>
                    </form>
