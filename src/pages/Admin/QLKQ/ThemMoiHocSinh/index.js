    ...
    return ( 
        ...
        <div className={cx('table-tkb')}>
                ...
                <div className={cx('select-option')}>
                    <select className={cx('chon-hocsinh')} value={mahs} onChange={(e) => setMaHS(e.target.value)}>
            ...
            <button type='submit' className={cx('button-submit')}>Thêm mới</button>
                          ...
                          <button type="text" className={cx('come-back')} onClick={handleCancel}>Quay lại</button>
