                ...
                <div className={cx('bgr-content')}>
                    ...
                    <div className={cx('infor')}>
                        <div className={cx('diem-time')}>
                            <p>
                                <strong>Tên môn học:</strong> {monhoc ? monhoc.TenMonHoc : ''}
                            </p>
                            <p>
                                <strong>Họ và tên học sinh:</strong> {hs ? hs.HoHS : ''} {hs ? hs.TenHS : ''}
                            </p>
                        </div>
                        <div className={cx('diem-time')}>
                            <p>
                    ...
                    <form className={cx('form-create')} onSubmit={handleCreate}>
                        ...
                        />
                        <SelectLabels title="Loại điểm" select={loaiDiem} onChange={handleLoaiDiem} other="LoaiDiem" />
