    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <div
                    style={{ display: 'flex', cursor: 'pointer', alignItems: 'center', justifyContent: 'center' }}
                    onClick={() => handleTMHSClick(params.row)}
                >
                    <AccountBoxOutlined style={{ color: 'blue' }} />
            ...
            <div className={cx('innerr')}>
                <div className={cx('bgr-content')}>
                    ...
                    <div className={cx('button-create')}>
                        <Button type="text" primary to={config.routesAdmin.tmlh}>
                            Thêm mới KHHT
                        </Button>
                    ...
                    <div>
                        {onCancel ? <DeleteLichHoc onCancel={handleUpdateDiemCancel} lichHocID={selectedIDs} /> : ''}

                        {onCancel1 ? <ThemMoiHocSinh onCancel={handleIDLichHocChange} id={LichHocID} /> : ''}
