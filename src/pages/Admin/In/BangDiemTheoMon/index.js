        ...
        <Text style={styles.tableCell}>Ghi chú</Text>
            ...
            {hs.slice(pageIndex * itemsPerPage, (pageIndex + 1) * itemsPerPage).map((item, index) => (
              <View style={styles.tableRow} key={index}>
                ...
                <View style={styles.tableHoHS}><Text style={styles.tableCell}>{item.TenHocSinh}</Text></View>
                <View style={styles.tableDiemT}>
                  <View style={styles.tableRow}>
                      <View style={styles.tablehienThiDiem}><Text style={styles.tableCell}>{item.DHS1L1}</Text></View>
                      <View style={styles.tablehienThiDiem}><Text style={styles.tableCell}>{item.DHS1L2}</Text></View>
                      <View style={styles.tablehienThiDiem}><Text style={styles.tableCell}>{item ? item.DHS1L3 :""}</Text></View>
                      <View style={styles.tablehienThiDiem}><Text style={styles.tableCell}>{item.DQTHS1}</Text></View>
                  </View>
                </View>
                <View style={styles.tableDiemT}>
                  <View style={styles.tableRow}>
