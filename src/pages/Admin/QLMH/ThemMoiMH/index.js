...
function ThemMoiMH() {
  ...
  const navigate = useDispatch()
    ...
    const handleCreate= async(e) =>{
        ...
        console.log("lythuyet",lythuyet)
        console.log("thuchanh",thuchanh)
        console.log("thi",thi)
        console.log("nganh",nganh)
        console.log(" loaimonhoc", loaimonhoc)
    ...
    return ( 
      ...
      <div className={cx('innerr')}>
        ...
        <h2 className={cx('title')}>Thêm mới môn học</h2>
                ...
                <div>                 
                    <Input label='Mã môn học' placeholder='Vui lòng nhập mã môn học' onChange={(e) =>setMaMH(e.target.value)}/>
                   <br/>                               
                   <Input label='Tên môn học' placeholder='Vui lòng nhập tên môn học' onChange={(e) =>setTenmh(e.target.value)}/>          
                    <br/>
                   <Input label='Số tín chỉ' placeholder='Vui lòng nhập số tín chỉ' onChange={(e) =>setSoTC(e.target.value)}/>          
                   <br/>              
                   <Input label='Lý thuyết' placeholder='Vui lòng nhập số lý thuyết' onChange={(e) =>setLyThuyet(e.target.value)}/>          
                   <br/>  
                  </div>
                  
                  <div>
              
                   <Input label='Thực hành' placeholder='Vui lòng nhập số thực hành' onChange={(e) =>setThucHanh(e.target.value)}/>          
                  <br/>
                  
                   <Input label='Thi' placeholder='Vui lòng nhập số thi' onChange={(e) =>setThi(e.target.value)}/>          
                    <br/>
...
<div className={cx('button-class','tl')}>
   <Link to={config.routesAdmin.ttmh} className={cx('come-back')}>Quay lại</Link>
</div>
            </div>
                </form>
