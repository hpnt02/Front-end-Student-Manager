                ...
                <div className={cx('bgr-content')}>
                    ...
                    <form className={cx('form-create')} onSubmit={KhoahandleUpdate}>
                        <div className={cx('infor-new')}>
                            <div>
                                <Input
                                    label="Mã môn học"
                                    type="text"
                                    placeholder="Chỉnh sửa mã môn học"
                                    value={inputValue}
                                ...
                                <Input
                                    label="Tên môn học"
                                    type="text"
                                    placeholder="Chỉnh sửa tên môn học"
                                    value={inputTenMH}
                                ...
                                <Input
                                    label="Số tín chỉ"
                                    type="text"
                                    placeholder="Chỉnh sửa số tín chỉ"
                                    value={inputSoTC}
                            ...
                            <div>
                                <Input
                                    label="Lý thuyết"
                                    type="text"
                                    placeholder="Chỉnh sửa lý thuyết"
                                    value={inputLyThuyet}
                                ...
                                <Input
                                    label="Thực hành"
                                    type="text"
                                    placeholder="Chỉnh sửa thực hành"
                                    value={inputThucHanh}
                        ...
                        <div className={cx('format-button')}>
                            ...
                            <Button primary to={config.routesAdmin.qlmh}>
                                Quay lại
                            </Button>
                        </div>
                    </form>
