                ...
                <div className={cx('bgr-content')}>
                    ...
                    <form className={cx('form-create')} onSubmit={handleCreate}>
                        <div className={cx('infor-newstudent')}>
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setHoTenMe(e.target.value)}
                                />
                                <br />
                                <Input
                                    ...
                                    onChange={(e) => setNgheNghiepMe(e.target.value)}
                                />
                                <br />
                                <Input
                                    ...
                                    onChange={(e) => setSDTMe(e.target.value)}
                                />
                            </div>
                            <div>
                                <Input
                                    ...
                                    onChange={(e) => setHoTenCha(e.target.value)}
                                />
                                <br />
                                <Input
                                    ...
                                    onChange={(e) => setNgheNghiepCha(e.target.value)}
                                />
                                <br />
                                <Input
                                    ...
                                    onChange={(e) => setSDTCha(e.target.value)}
                                />
                            </div>
                        </div>
                        <div className={cx('format-button')}>
                            ...
                            <Button type="text" primary to={config.routesAdmin.dsph}>
                                Quay lại
                            </Button>
                        </div>
                    </form>
