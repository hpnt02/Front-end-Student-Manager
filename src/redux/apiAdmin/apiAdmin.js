...
import {
    getDSHSStart,getDSHSSuccess,getDSHSFailed,
    TMHSFailed,TMHSStart,TMHSSuccess,
    getNGANHStart,getNGANHSuccess,getNGANHFailed,
    getKhoaStart,getKhoaSuccess,getKhoaFailed,
    deleteUserStart,deleteUserSuccess,deleteUserFailed,
    UpdateStart,UpdateSuccess,UpdateFailed,
    UpdateNganhStart,UpdateNganhSuccess,UpdateNganhFailed,
    TMNStart,TMNSuccess,TMNFailed,
    deleteNganhStart,deleteNganhSuccess,deleteNganhFailed,
    TMKStart,TMKSuccess,TMKFailed,
    UpdateKhoaStart,UpdateKhoaSuccess,UpdateKhoaFailed,
    deleteKhoaStart,deleteKhoaSuccess,deleteKhoaFailed,
} from '../DSHS';

import{
    getGiaoVienStart,getGiaoVienSuccess,getGiaoVienFailed,
    TMGVStart,TMGVSuccess,TMGVFailed,
    deleteGiaoVienStart,deleteGiaoVienSuccess,deleteGiaoVienFailed,
    UpdateGiaoVienStart,UpdateGiaoVienSuccess,UpdateGiaoVienFailed,
} from '../GiaoVien';
